...
Why do you want to work at QA Wolf? Please record a short, ~2 min, video with your answer and a walkthrough demonstration of your code (showing a successful execution). Post the link in `why_qa_wolf.txt` (Please use [Loom](https://www.loom.com) to record your response)
